...
<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
  <div class="grid grid-cols-1 gap-4 sm:grid-cols-4">
    {#each data.data as document (document.id)}
      <div class="rounded-lg border border-gray-300 group relative bg-white shadow-sm p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500">
        <div>
        ...
        <div class="mt-6">
          ...
          <p class="mt-2 text-sm text-gray-500">{document.body}</p>
        </div>
        <a href="{document.url}" target="_blanc" class="absolute right-6 top-6 text-gray-300 group-hover:text-gray-400" aria-hidden="true">
